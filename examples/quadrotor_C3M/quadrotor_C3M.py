...
class TC_Simulate(object):
    def __init__(self):
        ...
        self.C3M = C3M('/home/daweis2/HSCC/Learning-Discrepancy/examples/quadrotor_C3M/data/model_best.pth.tar')
        ref = loadpklz('/home/daweis2/HSCC/Learning-Discrepancy/examples/quadrotor_C3M/data/ref.pklz')
        self.xref = ref['xref']
        self.uref = ref['uref']
        self.t = ref['t']
